...
TestDom.__name__ = "TestDom";
TestDom.createEvent = function(el,etype) {
	el.dispatchEvent(new Event(etype));
};
TestDom.__super__ = utest_Test;
TestDom.prototype = $extend(utest_Test.prototype,{
	box: null
	,setup: function() {
	...
	,testtest: function() {
		utest_Assert.isTrue(true,null,{ fileName : "tests/TestDom.hx", lineNumber : 18, className : "TestDom", methodName : "testtest"});
	}
	,testDom: function() {
		var _gthis = this;
		utest_Assert.notNull(window.document,null,{ fileName : "tests/TestDom.hx", lineNumber : 22, className : "TestDom", methodName : "testDom"});
		utest_Assert.notNull(this.box,null,{ fileName : "tests/TestDom.hx", lineNumber : 23, className : "TestDom", methodName : "testDom"});
		var qBox = window.document.querySelector("#box");
		utest_Assert.equals(this.box.id,"box",null,{ fileName : "tests/TestDom.hx", lineNumber : 25, className : "TestDom", methodName : "testDom"});
		qBox.addEventListener("click",function(ev) {
			utest_Assert.equals(ev.target,_gthis.box,null,{ fileName : "tests/TestDom.hx", lineNumber : 27, className : "TestDom", methodName : "testDom"});
			utest_Assert.equals(ev.target.id,"box",null,{ fileName : "tests/TestDom.hx", lineNumber : 28, className : "TestDom", methodName : "testDom"});
		});
		TestDom.createEvent(qBox,"click");
	}
	,click: function() {
	}
